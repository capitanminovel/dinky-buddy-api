...
def _legacy_key(p: dict) -> str:
    """Pre-2026-08-26 key scheme (name+brand+category text hash). Kept only to
    ...
    overwrite each other during the scrape loop. Same fix as mnlegitdev's
    repos applied 2026-07-15/2026-08-26 (see server-runbook incidents
    2026-07-15-preroll-false-new-badge-product-key-rewrite and
    2026-08-26-new-arrivals-first-seen-never-reset-on-restock)."""
